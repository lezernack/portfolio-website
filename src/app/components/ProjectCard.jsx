...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  ...
  return (
    <div>
      ...
      >
        <div className="overlay items-center justify-center absolute top-9 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500">
          <Link
            href={gitUrl}
